...
--
-- Host: localhost
-- Generation Time: Nov 20, 2014 at 05:13 PM
...
INSERT INTO `peripheral_device` (`peri_device_id`, `compatibility`, `peri_device_name`, `price`, `device_id`, `entertainment`, `everyday_task`, `communication`, `website`, `scheduling`) VALUES
(1, 0, 'hearing-aid helper', 10.99, 1, 0, 0, 0, '', 0),
(2, 0, 'crutch', 30, 5, 0, 0, 0, '', 0),
(3, 1, 'weelchair', 100, 3, 0, 0, 0, '', 0);
